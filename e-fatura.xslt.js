						...
						<tbody>
							...
							<tr style="height:118px; " valign="top">
								...
								<td width="20%" align="center" valign="center">
									<!-- <img width="175" style="text-align:right; margin-left:15px" align="middle" alt="İMZA" src=''/> -->
								</td>
								<!-- imza İmza Imza İMZA IMZA -->
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							<tr class="lineTableTr">
								...
								<!-- Fatura senaryosu yatırım teşvik ve istisna türündeyse vazgeçilen kdv yazmasını sağlar -->
								<td class="lineTableTd" style="width:7%" align="center">
									<span style="font-weight:bold;">
										<xsl:choose>
											<xsl:when test="//cbc:ProfileID = 'YATIRIMTESVIK' and //cbc:InvoiceTypeCode = 'ISTISNA'">
												<xsl:text>Vazgeçilen KDV Oranı</xsl:text>
											</xsl:when>
											<xsl:otherwise>
								...
								<td class="lineTableTd" style="width:10%" align="center">
									<span style="font-weight:bold;">
										<xsl:choose>
											<xsl:when test="//cbc:ProfileID = 'YATIRIMTESVIK' and //cbc:InvoiceTypeCode = 'ISTISNA'">
												<xsl:text>Vazgeçilen KDV Tutarı</xsl:text>
											</xsl:when>
											<xsl:otherwise>
					...
					<tbody>
						<tr>
							<td id="notesTableTd" height="">
								...
								<!-- <div>İRSALİYE YERİNE GEÇER</div> -->
								<table id="notesTable2" style="margin-top:2px; !important" width="800">
									<tr>

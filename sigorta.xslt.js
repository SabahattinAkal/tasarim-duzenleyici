...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:clm54217="urn:un:unece:uncefact:codelist:specification:54217:2001" xmlns:clm5639="urn:un:unece:uncefact:codelist:specification:5639:1988" xmlns:clm66411="urn:un:unece:uncefact:codelist:specification:66411:2001" xmlns:clmIANAMIMEMediaType="urn:un:unece:uncefact:codelist:specification:IANAMIMEMediaType:2003" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:lcl="http://www.efatura.gov.tr/local" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="cac cbc ccts clm54217 clm5639 clm66411 clmIANAMIMEMediaType fn link n1 qdt udt xbrldi xbrli xdt xlink xs xsd xsi lcl">
	...
	<xsl:template match="/">
								...
								<td width="40%">
									...
									<table align="center" border="0" width="100%">
										<tbody>
											...
											<xsl:for-each select="//n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification[1]">
												<tr align="left">
													<td>
								...
								<td width="20%" align="center" valign="middle">
									...
									<h1 align="center">
										<span style="font-weight:bold; ">
											<xsl:text>e-Sigorta Komisyonu Gider Belgesi</xsl:text>
										</span>
									</h1>
								</td>
								<td align="right">
		...
		"istihsalkomisyon":"<xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount"/>",
		"iptalkomisyon":"<xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount"/>"}
							...
							<tr style="height:118px; " valign="top">
												...
												<td>
													...
													<table align="center" border="0">
														<tbody>
															...
															<tr>
																<xsl:choose>
																	<xsl:when test="n1:CreditNote/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'PARTYTYPE' and text() = 'TAXFREE']">
																		<xsl:for-each select="n1:CreditNote/cac:BuyerCustomerParty/cac:Party">
																			<xsl:call-template name="Party_Title">
																				<xsl:with-param name="PartyType">TAXFREE</xsl:with-param>
																			</xsl:call-template>
																		</xsl:for-each>
																	</xsl:when>
																	<xsl:when test="n1:CreditNote/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'PARTYTYPE' and starts-with(text(), 'EXPORT')]">
																		<xsl:for-each select="n1:CreditNote/cac:BuyerCustomerParty/cac:Party">
																			<xsl:call-template name="Party_Title">
								...
								<td style="padding-right:25px;padding-top:10px" width="30%" align="right" valign="top">
									<!--<img style="height:125px;width:194px;" src=""/>-->
									<!--FİRMA IMZAımzaimzaİMZA SİRKÜSÜ -->
								</td>
									...
									<table border="1" id="despatchTable">
										<tbody>
											...
											<tr style="height:13px; ">
												<td align="left">
													<span style="font-weight:bold; ">
														<xsl:text>Ait Olduğu Dönem</xsl:text>
													</span>
												</td>
												<td align="left">
													<xsl:for-each select="n1:CreditNote/cac:InvoicePeriod/cbc:Description">
														<xsl:apply-templates/>
													</xsl:for-each>
												</td>
											</tr>
						...
						<tbody>
							<tr class="lineTableTr">
								...
								<td class="lineTableTd" style="width:7.4%" align="center">
									<span style="font-weight:bold;">
										<xsl:text>İptal Komisyonu</xsl:text>
									</span>
								</td>
								<td class="lineTableTd" style="width:9%" align="center">
									<span style="font-weight:bold;">
										<xsl:text>İstihsal Komisyonu</xsl:text>
									</span>
								</td>
							</tr>
									...
									<tbody>
										<tr align="right">
											...
											<td class="lineTableBudgetTd" align="right" width="200px">
												<span style="font-weight:bold;">
													<xsl:text>Toplam İptal Komisyonu Tutarı</xsl:text>
												</span>
											</td>
											<td class="lineTableBudgetTd" style="width:81px; " align="right">
												<xsl:for-each select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount">
										...
										<tr align="right">
											...
											<td class="lineTableBudgetTd" align="right" width="200px">
												<span style="font-weight:bold;">
													<xsl:text>Toplam İstihsal Komisyonu Tutarı</xsl:text>
												</span>
											</td>
											<td class="lineTableBudgetTd" style="width:81px; " align="right">
												<xsl:for-each select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount">
													<xsl:call-template name="Curr_Type"/>
												</xsl:for-each>
											</td>
										</tr>
										<tr align="right">
											...
											<td class="lineTableBudgetTd" width="200px" align="right">
												<span style="font-weight:bold; ">
													<xsl:text>Toplam Komisyon Tutarı</xsl:text>
												</span>
											</td>
		...
		<tr class="lineTableTr">
			...
			<td class="lineTableTd" align="right">
				...
				<xsl:for-each select="cac:AllowanceCharge">
					<xsl:if test="cbc:AllowanceChargeReason = 'IPTAL'">
						<xsl:text> </xsl:text>
			...
			<td class="lineTableTd" align="right">
				<xsl:text>&#160;</xsl:text>
				<xsl:for-each select="cac:AllowanceCharge">
					<xsl:if test="cbc:AllowanceChargeReason = 'Istihsal'">
						<xsl:text> </xsl:text>
						<xsl:for-each select="cbc:Amount">
							<xsl:call-template name="Curr_Type"/>
						</xsl:for-each>

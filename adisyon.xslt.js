...
"unvan":"<xsl:value-of select="translate(n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/>
										<xsl:value-of select="translate(n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Person/cbc:FirstName, 'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/>
										<xsl:value-of select="translate(n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Person/cbc:FamilyName, 'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/>",
...
"odenecek":<xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount"/>}
						...
						<tbody>
							<tr class="lineTableTr">
								...
								<td class="lineTableTd" style="width:10.6%" align="center">
									<span style="font-weight:bold;">
										<xsl:text>Toplam fiyat</xsl:text>
									</span>
								</td>
								<td class="lineTableTd" style="width:10.6%" align="center">
									<span style="font-weight:bold;">
				...
				<table id="budgetContainerTable" width="800px">
					...
					<tr align="right">
						...
						<td class="lineTableBudgetTd" style="width:82px; " align="right">
							<xsl:for-each select="n1:CreditNote/cac:AllowanceCharge/cbc:Amount">
								<xsl:call-template name="Curr_Type"/>
							</xsl:for-each>
						</td>
					</tr>
